...
export const generateBillPDF = (
  ...
  autoTable(doc, {
    ...
    didParseCell: (data) => {
        // Center the TOTAL label to the right of its cell merging isn't perfect in simple autotable usage,
        // but standard foot row works well enough.
    }
  });
  ...
  doc.rect(14, finalY + 1, 182, 8, 'F'); // Adjusted width to match table approx
  doc.setDrawColor(0);
